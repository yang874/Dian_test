...
plt.plot(x, Acc, marker='o', markersize=3, color='r')
plt.plot(x, Pre, marker='o', markersize=3, color='b')
plt.plot(x, Rec, marker='o', markersize=3, color='g')
plt.plot(x, F1, marker='o', markersize=3, color='y')
